...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        q_values = [(self.getQValue(state, action), action) for action in actions]
        max_q_value = max(q_values, key=lambda x: x[0])[0]
        best_actions = [action for q_value, action in q_values if q_value == max_q_value]
...
class PacmanQAgent(QLearningAgent):
    ...
    def __init__(self, epsilon=0.1, gamma=0.95, alpha=0.1, numTraining=2000, **args):
        """
